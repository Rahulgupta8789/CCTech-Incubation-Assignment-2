/*
Q4.Write a program to accept a string, a position P and a character T. Replace the character at position P 
in the string with character T.
*/
...
int main() 
{
    ...
    cout << endl << "string after replacing character : " << result;
